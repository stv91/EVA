...
app.controller('materialsController', function($scope, $http, $location, $alert) {
    ...
    $scope.refreshComments = function() {
        if (ID != null) {
            $http.get('/materials/getcomments.html?id=' + ID).
            ...
            setup: function(editor) {
                editor.addButton('save', {
                    ...
                    onclick: function() {
                        ...
                        editor.setContent("");
                        $http.post("/materials/savecomment.html", {
                            id: ID,
                            content: content,
                            reply: commentID
                        });
            ...
            setup: function(editor) {
                editor.addButton('save', {
                    ...
                    onclick: function() {
                        ...
                        $http.post("/materials/savedescription.html", {
                            id: ID,
    ...
    $scope.searchMaterials = function() {
        ...
        ID = null;
        $http.post('/materials/searchmaterials.html', $scope.search).
        success(function(data, status, headers, config) {
            $scope.results = data;
        }).
    ...
    $scope.askMaterial = function(id) {
        ID = id;
        $http.post('/materials/getmaterial.html?id=' + id).
        success(function(data, status, headers, config) {
            ...
            $http.get('/materials/getcurrentuser.html').success(function(user) {
    ...
    $scope.deleteMaterial = function() {
        if(ID != null) {
            $http.post('/materials/deletematerial.html?id='+ID)
            .success(function(data, status, headers, config) {
                if(data == "OK") {
